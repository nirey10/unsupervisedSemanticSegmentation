...
class PotsdamDataset(Dataset):
    def __init__(self, data_root='Potsdam/data/', mode='val', img_dir='images', mask_dir='masks',
        ...
        self.img_ids, self.img_ids_label = self.get_img_ids(self.data_root, self.img_dir, self.mask_dir)
    ...
    def get_img_ids(self, data_root, img_dir, mask_dir):
        ...
        img_ids_labels = [str(id.split('.')[0]) for id in mask_filename_list]
        return img_ids, img_ids_labels

    def load_img_and_mask(self, index):
        img_id = self.img_ids[index]
        label_id = self.img_ids_label[index]
        img_name = osp.join(self.data_root, self.img_dir, img_id + self.img_suffix)
        mask_name = osp.join(self.data_root, self.mask_dir, label_id + self.mask_suffix)
